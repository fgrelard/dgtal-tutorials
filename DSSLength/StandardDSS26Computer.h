 ...
 * @date 2011/06/01
 *
 * Header file for module StandardDSS26Computer.cpp
 *
...
#if defined(StandardDSS26Computer_RECURSES)
#error Recursive header files inclusion detected in StandardDSS26Computer.h
#else // defined(StandardDSS26Computer_RECURSES)
/** Prevents recursive inclusion of headers. */
#define StandardDSS26Computer_RECURSES

#if !defined StandardDSS26Computer_h
/** Prevents repeated inclusion of headers. */
#define StandardDSS26Computer_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // class StandardDSS26Computer
  /**
   * Description of class 'StandardDSS26Computer' <p>
   * \brief Aim:
  ...
  public:
    ...
    typedef StandardDSS26Computer<ConstIterator,TInteger,connectivity> Self; 
    typedef StandardDSS26Computer<ReverseIterator<ConstIterator>,TInteger,connectivity> Reverse;
    ...
    typedef DGtal::NaiveDSS8Computer<IteratorAdapter,TInteger> ArithmeticalDSSComputer2d;
  ...
  public:
     ...
     * @see init
     */
    StandardDSS26Computer(const ConstIterator& it);
     ...
     */
    StandardDSS26Computer ( const StandardDSS26Computer & other );
     ...
     */
    StandardDSS26Computer & operator= ( const StandardDSS26Computer & other );
     ...
     * and 'false' otherwise
     */
    bool operator==( const StandardDSS26Computer & other ) const;
  ...
  }; // end of class StandardDSS26Computer



  /**
   * Overloads 'operator<<' for displaying objects of class 'StandardDSS26Computer'.
   * @param out the output stream where the object is written.
   * @param object the object of class 'StandardDSS26Computer' to write.
   * @return the output stream after the writing.
   */
  template <typename TIterator, typename TInteger, int connectivity>
  std::ostream&
  operator<< ( std::ostream & out,  StandardDSS26Computer<TIterator,TInteger,connectivity> & object )
  {
...
#include "StandardDSS26Computer.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined StandardDSS26Computer_h

#undef StandardDSS26Computer_RECURSES
#endif // else defined(StandardDSS26Computer_RECURSES)
