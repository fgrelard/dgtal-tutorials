...
int main(int argc, char** argv) {
	...
	Z3i::Point p1 = inputDomain.lowerBound();
	Z3i::RealVector translationVector(-p1[0]+1, -p1[1]+1, -p1[2]+1);
	Z3i::Point lowerBound = inputDomain.lowerBound() + translationVector;
	Z3i::Point tmp = (inputDomain.upperBound() - inputDomain.lowerBound());
	Z3i::Point upperBound = Z3i::Point(tmp[0], tmp[1], tmp[2]) + lowerBound;

	Z3i::Point paddingPoint(1, 1, 1);
	int sx = 1, sy = 1, sz = 1;
